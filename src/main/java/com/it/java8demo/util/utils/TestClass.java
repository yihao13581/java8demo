package com.it.java8demo.util.utils;
...
public class TestClass {
	public static void main(String[] args) throws Exception {
		String strAddr=Base64.encode("oNest_P/captureImage/ISCDAS/202001/2019101217021900004/2020011315413583785002_1.jpg".getBytes("UTF-8"));
